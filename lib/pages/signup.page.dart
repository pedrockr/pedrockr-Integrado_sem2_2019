...
class _SignupPageState extends State<SignupPage> {
  ...
  TextEditingController controller_usuario_matricula =
      new TextEditingController();
  TextEditingController controller_usuario_senha = new TextEditingController();
  TextEditingController controller_conf_usuario_senha =
      new TextEditingController();
  ...
  void CadastrarAta() async {
    var url =
        "https://www.marciosantos.com.br/flutterHunt/mobile/usuario/cadastro_de_usuario.php?id=1";
            ...
            Container(
              ...
              child: SizedBox.expand(
                child: FlatButton(
                  ...
                  onPressed: () {
                    if (controller_conf_usuario_senha.text ==
                        controller_usuario_senha.text) {
                      CadastrarAta();
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                      ...
                      Toast.show("Senhas diferentes", context,
