...
import 'cadastro_ata.dart';
import 'editar_ata.dart';
import 'visualizar_ata.dart';

class IndexAta extends StatefulWidget {
    IndexAta({this.username, this.usernivel});
    final String username;
    final String usernivel;
  @override
  _IndexAtaState createState() => new _IndexAtaState();
}

class _IndexAtaState extends State<IndexAta> {
  //VARIAVEIS
  ...
  Future<List> getData() async {
    var sql = "https://www.marciosantos.com.br/flutterHunt/mobile/ata_de_reuniao/atas_cadastradas.php";
              ...
              onTap: () => Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (BuildContext context) =>
                      visualizarAta(list: list, index: i),
                ),
              ),
              child: Card(
                elevation: 5,
                child: ListTile(
                  title: Text(list[i]['ata_nome']),
                  subtitle: Text(list[i]['ata_pauta']),
                  trailing: Text(list[i]['ata_data_e_hora']),                  
                ),
              ),
            ),
          );
